        ...
        <footer className="flex md:flex-row md:items-center justify-around gap-4 p-6 mt-4 md:sticky lg:sticky md:bottom-0 border-t-2 border-[#8672c693] sm:text-xs flex-col bg-[#f5e5d6] rounded-2xl shadow mb-2">
            ...
            <div className="flex flex-col">
                ...
                <span className="text-sm">
                    <a href="mailto:ibrahimwalle20@gmail.com">ibrahimwalle20@gmail.com</a>
                </span>
            </div>
            <div className="flex flex-col">
                <span className="font-bold">Social</span>
                <span className="text-sm flex gap-2">
                    <a href="https://www.linkedin.com/in/ibrahim-alwali/" target="_blank">
                    ...
                    <a href="https://www.github.com/ibrahimwalle" target="_blank">
            ...
            <div className="flex flex-col">
                ...
                <a href="https://wali-photo.netlify.app/" target="blank" className="text-sm">Wali Photo</a>
            </div>
        </footer>
    )
